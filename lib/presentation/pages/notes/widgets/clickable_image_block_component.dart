...
class ClickableImageBlockComponentBuilder extends BlockComponentBuilder {
  ClickableImageBlockComponentBuilder({
    super.configuration,
  });
  ...
  BlockComponentWidget build(BlockComponentContext blockComponentContext) {
    ...
    return ClickableImageBlockComponentWidget(
      key: node.key,
      node: node,
...
class ClickableImageBlockComponentWidget extends BlockComponentStatefulWidget {
  const ClickableImageBlockComponentWidget({
    super.key,
    required super.node,
    super.showActions,
    super.actionBuilder,
  ...
  @override
  State<ClickableImageBlockComponentWidget> createState() =>
      _ClickableImageBlockComponentWidgetState();
}

class _ClickableImageBlockComponentWidgetState
    extends State<ClickableImageBlockComponentWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final alignment = _alignmentFromString(
    ...
    if (src is String && src.isNotEmpty) {
      child = GestureDetector(
        ...
        onTap: () => showImagePreviewDialog(context, src: src),
        child: child,
      );
    }
...
Alignment _alignmentFromString(String name) {
  switch (name) {
    case 'left':
